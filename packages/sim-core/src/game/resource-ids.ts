...
export const R_REGOLITH = "regolith";
export const R_WATER_ICE = "water-ice";
export const R_LOX = "lox";
export const R_SLAG = "metal-slag";
export const R_TAILINGS = "tailings";
